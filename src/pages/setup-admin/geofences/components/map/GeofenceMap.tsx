...
// 	setMap: (map: any) => void | Promise<void>;
// 	cercleGeofence: any;
...
// 	const { geofencePointCenter } = useSelector((state: RootState) => state.appStoreNoPersist);
...
// 	const mapCenter = !inMyFleet ? cercleGeofence : geofencePointCenter;
...
// 				//   mapRef.current = mapInstance; // <-- important
// 				//   setMap(mapInstance);          // your parent setter
// 				// }}
// 				ref={mapRef} // <-- set ref here
// 				style={{
